  ...
  const loadRecipe = async () => {
    ...
    try {
      ...
      if (err.response?.status === 404) {
        setError(
          "Recipe not found. It may have been removed or the link is incorrect."
        );
      ...
      switch (errorType) {
        case "notFound":
          return {
            ...
            description:
              "Sorry, we couldn't find the recipe you're looking for. It may have been removed or the link is incorrect.",
            suggestions: [
        ...
        case "unauthorized":
          return {
            ...
            title: "Access Denied",
            description:
              "You don't have permission to view this recipe. It might be a private recipe or require special access.",
            suggestions: [
              { text: "Login to Account", link: "/login", primary: true },
              {
                text: "Browse Public Recipes",
                link: "/search",
                primary: false,
              },
            ],
        ...
        default:
          return {
            ...
            description:
              error ||
              "Unable to load the recipe. Please try again or contact support if the problem persists.",
            suggestions: [
              { text: "Try Again", action: loadRecipe, primary: true },
    ...
    return (
      <div className="flex items-center justify-center min-h-screen px-4 bg-orange-50">
        <div className="w-full max-w-md text-center">
          {/* Error Icon */}
          <div className="mb-6 text-8xl animate-bounce">{errorConfig.icon}</div>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <div className="space-y-6 lg:col-span-5">
            ...
            {/* Rating Section - Authenticated only */}
            {isAuthenticated && (
          ...
          {/* RIGHT: Recipe Info */}
          <div className="space-y-6 lg:col-span-7 font-brand">
            {/* Title + Description + Tags */}
            <div className="flex flex-col gap-2 mt-4 mb-3 sm:flex-row sm:items-start sm:justify-between">
              <div className="flex-1">
                <div className="flex flex-wrap items-center gap-3">
                  <h1 className="text-3xl font-semibold leading-tight text-orange-800 lg:text-4xl font-brand">
                    {recipe.title}
                  </h1>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1 sm:items-end">
                <p className="flex items-center text-sm text-gray-500 font-brand mr-2">
                ...
                {recipe.updated_at &&
                  recipe.updated_at !== recipe.created_at && (
                    <p className="text-xs text-gray-400 font-brand mr-2">
                      Updated:{" "}
            ...
            <div className="flex flex-col flex-wrap gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              {/* Author - kanan */}
              <div className="flex items-center gap-3 mt-1 ml-auto sm:mt-0 mr-2">
                <div className="flex items-center gap-2">
            ...
            {/* Stats */}
            <div className="p-10 bg-white border border-orange-100 shadow-lg rounded-2xl">
              <h3 className="text-lg font-semibold text-gray-700 font-brand mb-6">
                Recipe Details
              </h3>
                ...
                <div className="space-y-4">
                  <div className="p-4 border-l-4 border-orange-400 rounded-lg bg-orange-50">
                    ...
                    <p className="text-sm text-orange-700">
                      Read through all instructions first. Prep your ingredients
                ...
                <div className="space-y-4">
                  <div className="p-4 border-l-4 border-blue-400 rounded-lg bg-blue-50">
                    ...
                    <p className="text-sm text-blue-700">
                      Check your pantry first! You might already have some of
                      these ingredients.
                    </p>
                  </div>
                  ...
                  <div className="p-4 border rounded-lg bg-gray-50">
                    <p className="text-sm text-center text-gray-600">
                      📝 Total ingredients:{" "}
                      <strong>{recipe.ingredients.length}</strong> items
                    </p>
                  </div>
                </div>
              ) : (
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 border-l-4 border-green-400 rounded-lg bg-gradient-to-r from-green-50 to-blue-50">
                ...
                <p className="text-sm text-green-700">
                  Values are estimated based on {recipe.servings || 1} serving
                  {recipe.servings > 1 ? "s" : ""}.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 sm:grid-cols-4">
                ...
                <div className="p-6 text-center transition-shadow bg-white border border-gray-100 rounded-lg shadow-sm hover:shadow-md">
                  ...
                  {recipe.fat && <p className="text-xs text-gray-500">grams</p>}
                </div>
              </div>
              ...
              {(recipe.fiber || recipe.sugar || recipe.sodium) && (
                <div className="p-6 border rounded-lg bg-gray-50">
                  <h3 className="mb-4 font-semibold text-center text-gray-700">
